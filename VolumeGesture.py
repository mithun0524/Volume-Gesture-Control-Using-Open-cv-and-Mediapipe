...
while True:
  ...
  cv2.putText(frame, f'FPS: {int(fps)}', (40, 50), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
  
  cv2.putText(frame, 'Volume Gesture Control', (200, 50), cv2.FONT_HERSHEY_PLAIN, 1.5, (0, 0, 255), 2)
